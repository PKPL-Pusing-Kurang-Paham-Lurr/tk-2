...
const rickrollUrl = "https://youtu.be/dQw4w9WgXcQ?si=ApG05MAbLVcAJzgY";

export default function FooterSection() {
  return (
    <footer className="py-16 md:py-32">
      <div className="mx-auto max-w-5xl px-6">
        <span className="mx-auto block size-fit cursor-default text-xl font-bold tracking-tight text-foreground">
        ...
        <span className="text-muted-foreground block text-center text-sm">
          {" "}
          © {2026} PKPL: Pusing Kurang Paham Lur, All rights reserved
        </span>
      </div>
    </footer>
  );
